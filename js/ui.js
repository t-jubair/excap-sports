...
function ensureHelpFab() {
  ...
  if (!b) {
    b = document.createElement("button"); b.id = "help-fab"; b.type = "button"; b.setAttribute("aria-label", "Get help");
...
/* ============================================================
   NAV + DRAWER
   ============================================================ */
const NAV = [["home", "Home"], ["live", "Live"], ["fixtures", "Fixtures"], ["teams", "Teams"], ["tournament", "Tournament"], ["register", "Register"]];
...
function observeReveal() {
  ...
  setTimeout(() => $$(".reveal:not(.in)").forEach(el => { const r = el.getBoundingClientRect(); if (r.top < innerHeight * 1.4) el.classList.add("in"); }), 400);
}
